...
int main(int argc, char **argv){
    ...
    time_t end_time = time(NULL); //time object to know the end of the simuation
    std::cout << "Total Simulation Time: " << (end_time - start_time) / 60 <<"\n"; //calculates the total simulation time in minutes and displays that it console
    return 0;
}